...
*/
class DpsPxPayWpscResponseResult extends DpsPxPayWpscResponse {
	...
	*/
	protected function getMessageInvalid() {
		return __('Invalid response from Payment Express for payment response', 'dps-pxpay-for-wp-ecommerce');
	}
